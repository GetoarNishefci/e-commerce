    ...
    <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
              ...
              <FormItem>
                ...
                <FormControl>
                    <ImageUpload     value={field.value.map((images) => images.url)} disabled={loading}
        ...
        <div className="grid grid-cols-3 gap-8">
              ...
              <FormItem>
                <FormLabel>Category</FormLabel>
                    <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                        <FormControl>
                            <SelectTrigger>
                                    <SelectValue defaultValue={field.value} placeholder="Selecte a Category"/>
              ...
              <FormItem>
                <FormLabel>Size</FormLabel>
                    <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                        <FormControl>
                            <SelectTrigger>
                                    <SelectValue defaultValue={field.value} placeholder="Selecte a Size"/>
                            </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                            {sizes.map((size)=>(
              ...
              <FormItem>
                <FormLabel>Color</FormLabel>
                    <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                        <FormControl>
                            <SelectTrigger>
                                    <SelectValue defaultValue={field.value} placeholder="Selecte a Color"/>
                            </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                            {colors.map((color)=>(
            ...
            <Button disabled={loading} className="ml-auto" typeof="submit">{action}</Button>      
        </form>
            <Separator/>
    </Form>
    </>
